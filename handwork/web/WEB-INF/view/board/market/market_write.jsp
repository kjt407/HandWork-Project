                ...
                <div class="board-write-header">
                    ...
                    <div class="board-write-row">
                        ...
                        <div class="board-write-col location-select-col">
                            <p class="input-label">공방위치</p>
                            <input type="text" name="flocation" id="flocation" class="board-write-flocation" placeholder="이곳을 클릭하여 위치를 설정하세요" value="${r.flocation}" required/>
                            <input type="hidden" name="location" id="location" class="board-write-location" value="${r.location}" required/>
                        </div>
                    </div>
                    <div class="board-write-row">
                    ...
                    <div class="board-write-row">
                        ...
                        <div class="board-write-col period-col">
                            ...
                            <input type="number" min="0" max="180" name="period" placeholder="기간을 일단위로 입력해 주세요" value="${r.period}"class="board-write-period" id="board-write-period" required>
                        </div>
                    </div>
