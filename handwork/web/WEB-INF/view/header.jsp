						...
						<li>카테고리
							<div class="header-sub">
								<ul class="inner-ul">
									...
									<li><a href="${pageContext.request.contextPath}/search?q=&c=가구/인테리어">가구/인테리어</a></li>
									<li><a href="${pageContext.request.contextPath}/search?q=&c=식품">식품</a></li>
									<li><a href="${pageContext.request.contextPath}/search?q=&c=문구/잡화">문구/잡화</a></li>
									<li><a href="${pageContext.request.contextPath}/search?q=&c=생활용품">생활용품</a></li>
								</ul>
							</div>
						</li>
						<li>장터
